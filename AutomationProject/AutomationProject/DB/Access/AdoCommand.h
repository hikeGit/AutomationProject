...
public:
	CAdoParameter();
	CAdoParameter(ADODB::DataTypeEnum DataType, long lSize, ParameterDirectionEnum Direction, CString strName);
...
public:
	...
	_RecordsetPtr CAdoCommand::Executes(long Options = adCmdStoredProc);
	BOOL Cancel();
